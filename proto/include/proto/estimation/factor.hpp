...
struct ba_factor_t : factor_t {
  ...
  bool eval(real_t const *const *params) {
    ...
    const CAMERA cam_model{img_w, img_h, params[2], params[3]};
    ...
    jacobians[3] = -1 * cam_model.J_point() * cam_model.distortion.J_param(p);
...
//     const CM cam_model{img_w, img_h, params[3]};
