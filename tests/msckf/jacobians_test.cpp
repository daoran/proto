...
int test_p_c2_f_jacobian_wrt_theta1() {
  for (int i = 0; i < 1000; i++) {
    ...
    const vec3_t p_c2_f_jacobian = p_c2_f_jacobian_wrt_theta1(p_c1_f,
                                                              ...
                                                              w2,
                                                              theta1_offset);
    const vec3_t diff = p_c2_f_jacobian - finite_diff;
...
int test_p_c2_f_jacobian_wrt_theta2() {
  for (int i = 0; i < 1000; i++) {
    ...
    // Calculate jacobian using function generated using Matlab
    const vec3_t p_c2_f_jacobian = p_c2_f_jacobian_wrt_theta2(p_c1_f,
                                                              tau_s,
                                                              tau_d,
                                                              Lambda1,
                                                              w1,
