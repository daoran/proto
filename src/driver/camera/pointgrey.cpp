#include "prototype/driver/camera/pointgrey.hpp"
...
PointGrey::~PointGrey() {
  ...
  if (this->initialized && this->pointgrey) {
    ...
    if (error != FlyCapture2::PGRERROR_OK) {
      LOG_ERROR("Failed to stop PointGrey capture!");
    }

    // disconnect
    error = this->pointgrey->Disconnect();
    if (error != FlyCapture2::PGRERROR_OK) {
      LOG_ERROR("Failed to disconnect PointGrey!");
    }
...
int PointGrey::setBrightness(double brightness) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::setFrameRate(double fps) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::setExposure(double exposure_val) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::setShutter(double shutter_ms) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::setGain(double gain_db) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::getBrightness(double &brightness) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::getFrameRate(double &fps) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::getExposure(double &exposure_val) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::getShutter(double &shutter_ms) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::getGain(double &gain_db) {
  FlyCapture2::Property property;
  FlyCapture2::Error error;
...
int PointGrey::printFormat7Capabilities() {
  bool supported;
...
int PointGrey::setFormat7(const int mode,
...
std::pair<int, int> PointGrey::centerROI(const int size,
                                               const int max_size,
                                               const int step) {
  double roi_size;
...
int PointGrey::changeMode(const std::string &mode) {
  // pre-check
...
int PointGrey::getFrame(cv::Mat &image) {
  double data_size;
  double data_rows;
