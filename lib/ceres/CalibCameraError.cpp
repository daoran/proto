...
Mat2 CalibCameraError::get_covariance_matrix() const { return covar_; }

bool CalibCameraError::get_residuals(Vec2 &r) const {
  r = residuals_;
  return valid_;
}

bool CalibCameraError::get_reproj_error(double *error) const {
